...
var AssetsManager = (function(_super) {
    ...
    var preload = [
        ...
        {
            url: "assets/atlas/assets/ui.game.json",
            type: Laya.Loader.ATLAS
        },
    ...
    var preloadFonts = [
        ...
        {
            url: "assets/fonts/playerBet.fnt",
            type: Laya.Loader.XML
        },

        {
            url: "assets/fonts/online.fnt",
            type: Laya.Loader.XML
        },

        {
            url: "assets/fonts/online_all.fnt",
            type: Laya.Loader.XML
        },

        {
            url: "assets/fonts/jackpot.fnt",
            type: Laya.Loader.XML
        },

        {
            url: "assets/fonts/people.fnt",
            type: Laya.Loader.XML
        },

        {
            url: "assets/fonts/time.fnt",
            type: Laya.Loader.XML
        },
