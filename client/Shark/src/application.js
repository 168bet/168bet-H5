var Application = (function () {
    ...
    Application.init = function () {
        ...
        // Controllers
        this.game = new Papaya.Shark.Game();
    ...
    Application.preload = function() {
        ...
        async.series([
            ...
            function(callback) {
                ...
                self.animManager.initByJson(function() {
                    callback(null);
                });
            }
            ...
            self.massageView = new MassageView();
            //self.battleView = new MassageView();
            //self.event(Shark.Event.INITED);
        });
    };
    ...
    Application.runBattleView = function() {
        this.runView(this.battleView);
        this.battleView.init();
        this.state = Application.STATE_RUNNING;
    };

    Application.runMassageView = function(surviveFish,winRate,winReward) {
        this.sceneLayer.addChild(this.massageView);
        this.massageView.show(surviveFish,winRate);

        var self = this;
        var callBack = function(){
            self.massageView.off(MassageView.battleViewGoldRoll,this,callBack);
            self.battleView.goldRollAni(winReward);
        };

        this.massageView.on(MassageView.battleViewGoldRoll,this,callBack)
    };

    Application.removeMassageView = function() {
        this.massageView.dispose();
        this.sceneLayer.removeChild(this.massageView);
    };
    ...
    Application.start = function () {
        Laya.SoundManager.playMusic("assets/ui.sounds/music_blue_loading.mp3", 100000);
        // 创建加载场景
